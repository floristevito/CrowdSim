...
from ema_workbench.connectors.vadere import SingleReplicationVadereModel, VadereModel
...
def get_vadere_formulation(id, replications, model_file):
    ...
    if replications == 1:
        model = SingleReplicationVadereModel(
            ...
            processor_files=["density.txt", "speed.txt"],
    ...
    # id 5 describes a configuration with 4 uncertainties for SOBOL
    # all outcomes: speed outcome + 6 density based outcomes
    elif id == 5:
        model.uncertainties = [
            IntegerParameter(
                name="spawnFrequencyC",
