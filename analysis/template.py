...
model = get_vadere_formulation(id=1, replications=1, model_file="baseCaseData.scenario")
...
if __name__ == "__main__":
    ...
    results = perform_experiments(model, scenarios=3, uncertainty_sampling=Samplers.LHS)
